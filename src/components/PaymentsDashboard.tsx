...
const PaymentsDashboard = () => {
    const { orders, currentTenantId, deleteOrder, cashRegister, openRegister, closeRegister, user, isAdmin, branding } = useStore();
                        ...
                        {cashRegister.isOpen && (
                            <>
                                ...
                                <button
                                    ...
                                    className="px-6 py-3 bg-red-500/10 hover:bg-red-500 text-red-500 hover:text-text border border-red-500/20 rounded-2xl text-[10px] font-black uppercase transition-all"
                                >
                                    Close Shift
                                </button>
                            </>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="glass-card p-8 rounded-[2.5rem] relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <div className="w-14 h-14 bg-success/10 rounded-2xl flex items-center justify-center text-success mb-6 border border-success/20">
                            <Banknote size={28} />
                        </div>
                        <h3 className="text-muted font-bold uppercase text-[10px] tracking-[0.2em] mb-2">Total Cash Payments</h3>
                        <div className="text-5xl font-black text-text mb-4">£{cashTotal.toFixed(2)}</div>
                        <div className="flex items-center gap-2 text-success text-xs font-bold">
                            <ArrowUpRight size={14} />
                            Physical Currency reconcile
                        </div>
                    </div>
                </div>
                ...
                <div className="glass-card p-8 rounded-[2.5rem] relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        ...
                        <h3 className="text-muted font-bold uppercase text-[10px] tracking-[0.2em] mb-2">Total Card Payments</h3>
                        <div className="text-5xl font-black text-text mb-4">£{cardTotal.toFixed(2)}</div>
                        <div className="flex items-center gap-2 text-primary text-xs font-bold">
                            <ArrowUpRight size={14} />
                            Digital Terminal reconcile
                        </div>
                    </div>
                </div>
            </div>
